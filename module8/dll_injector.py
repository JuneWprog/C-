...
print"[*]memory space for dll: 0x%08x" %arg_address
...
print"[*]address of LoadLibraryA: 0x%08x" %h_loadlib
...
thread=kernel32.CreateRemoteThread(h_process,None,0,h_loadlib,arg_address,0,byref(thread_id))
if not thread:
